...
function Settings({ userRole, username }) {
  ...
  const handleChangeTelegramId = async (e) => {
    ...
    try {
      ...
      if (data.success) {
        setMessage(
          "Telegram User ID updated successfully. You can now use the bot as an admin.",
        );
  ...
  return (
    <div className="settings">
      <div className="header">
        <h1>
          <MdSettings className="title-icon" /> Settings
        </h1>
      </div>
      ...
      <div className="settings-content">
        ...
        <div className="settings-section">
          <h2>
            <MdAccountCircle /> Telegram Bot Admin Access
          </h2>
          <div
            className="info-box"
            style={{
              background:
                "linear-gradient(135deg, rgba(0, 136, 204, 0.1), rgba(0, 102, 255, 0.1))",
          ...
          >
            ...
            <p style={{ margin: "0 0 5px 0", fontSize: "13px" }}>
              ...
              <strong>{currentTelegramId || "Not set"}</strong>
            </p>
            <p
              style={{
                margin: "0",
            ...
            >
              {currentTelegramId
                ? "✅ You can now use admin commands in the Telegram bot!"
                : "⚠️ Set your ID to access admin features in the bot"}
            </p>
          </div>
